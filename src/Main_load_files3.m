...
% HOTMIRROR_XLSX   Hot-mirror spreadsheet for this case (case 3).
% SCRATCH_DIR      Reused (geometry-only) outputs.
% SCRATCH_DIR1     Case-specific outputs (theta sensitivity branch).
PLOTS_BASE     = 'plots_base.mat';
HOTMIRROR_XLSX = 'Hotmirror_T_R_case3.xlsx';
SCRATCH_DIR    = fullfile(pwd, 'scratch', 'uniform_plus');
SCRATCH_DIR1   = fullfile(pwd, 'scratch', 'theta');
%% ==================================================================
