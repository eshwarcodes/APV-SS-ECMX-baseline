function [Tcell, Tmodule] = pvl_sapmcelltemp(E, E0, a, b, windspeed, Tamb, deltaT,numPanels)
...
if ~isnumeric(E) || isempty(E) || any(isnan(E(:)))
    warning('Input E is invalid. Replacing with zeros.');
    E = zeros(size(windspeed));
end
