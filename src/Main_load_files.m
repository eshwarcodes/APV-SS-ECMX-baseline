...
folderName4 = fullfile(scratchDir, 'panelIrradiance');
if ~exist(folderName4, 'dir')
    mkdir(folderName4);
end

folderName5 = fullfile(scratchDir, 'groundIrradiance');
...
folderName9 = fullfile(scratchDir, 'spectral_components');
if ~exist(folderName9, 'dir')
    mkdir(folderName9);
end

folderName10 = fullfile(scratchDir, 'PVPerformance');
